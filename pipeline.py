...
class Pipeline():
    ...
    def run_on_video(self, videoFileName, cuda=False, roi_method='convexhull', roi_approach='holistic',
                     method='cpu_POS', bpm_type='welch', pre_filt=False, post_filt=True, verb=True):
        """
        ...
        sig_processing.set_total_frames(0) # 0 means all frames are being processed
        ...
        method_to_call = getattr(module, 'cpu_POS')
        method_device = 'cpu'
        pars = {'fps': 'adaptive'}
